...
* Creates set of Snowflake Roles to simplify access management
* Adds possibility to create custom Snowflake Roles
* Manages role-to-role, role-to-user assinments
